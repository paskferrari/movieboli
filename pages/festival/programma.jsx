...
const Programma = () => {
  ...
  const categorie = [
    ...
    { id: 'cortometraggi', label: 'Cortometraggi', color: 'from-blue-600 to-blue-700' },
    { id: 'ospiti', label: 'Ospiti', color: 'from-emerald-600 to-emerald-700' },
    { id: 'film', label: 'Film', color: 'from-amber-600 to-amber-700' }
  ]
