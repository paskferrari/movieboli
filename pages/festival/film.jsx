...
// Import dei dati film
import filmData from './film/film.json';

// Rimuovi questo import non utilizzato
...
const FilmPage = () => {
  ...
  // Organizza i film per giorno
  const filmByDay = {
    '22 agosto': filmData.filter(film => film.data_evento === '22 agosto 2025'),
    '23 agosto': filmData.filter(film => film.data_evento === '23 agosto 2025'),
    '24 agosto': filmData.filter(film => film.data_evento === '24 agosto 2025')
  };
  ...
  return (
    <>
      <Head>
        <title>Film del Festival 2025 | MOVIEBOLI Festival</title>
        <meta name="description" content={
          getContent('films.meta.description', 'Scopri i film in programmazione al MOVIEBOLI Film Festival 2025: lungometraggi selezionati e proiezioni speciali.')
        } />
        <meta property="og:title" content="Film del Festival 2025 | MOVIEBOLI Festival" />
        <meta property="og:description" content="Tre serate con i migliori film del cinema italiano contemporaneo." />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-movieboli-nero">
          <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-movieboli-crema/80">
              <EditableText 
                contentKey="films.loading.message"
                defaultValue="Caricamento film..."
                tag="span"
              />
            </p>
          </div>
          ...
          <div className="container mx-auto px-4 py-20 relative z-10">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-br from-movieboli-rosaPastello via-movieboli-violaPrincipale to-movieboli-violaSecondario drop-shadow-lg tracking-tight leading-tight">
                <EditableText 
                  contentKey="films.title"
                  defaultValue="Film in Programmazione al MOVIEBOLI Film Festival 2025"
                  tag="span"
                />
              </h1>
              <p className="text-lg md:text-xl text-movieboli-crema/80 mb-6 max-w-3xl mx-auto">
                <EditableText 
                  contentKey="films.subtitle"
                  defaultValue="Tre serate indimenticabili con i migliori film del cinema italiano contemporaneo"
                  tag="span"
                />
              </p>
          ...
          <div className="container mx-auto px-4">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Griglia Film - Card più grandi */}
                <div className={`grid gap-12 ${
                  filmByDay[activeDay]?.length === 1 
                    ? 'grid-cols-1 justify-items-center max-w-md mx-auto' 
                    : 'grid-cols-1 md:grid-cols-2'
                }`}>
                  {filmByDay[activeDay]?.map((film, index) => (
                    <motion.div
                      key={film.nome}
                      ...
                      whileTap={{ scale: 0.98 }}
                    >
                      {/* Poster Film - Molto più grande */}
                      <div className="relative w-56 h-80 mx-auto mb-8 rounded-2xl overflow-hidden border-4 border-movieboli-violaPrincipale/40 shadow-2xl">
                        <Image
                          src={film.foto}
                          alt={film.nome}
                          fill
                ...
                {(!filmByDay[activeDay] || filmByDay[activeDay].length === 0) && (
                  <div className="text-center py-16">
                    ...
                    <p className="text-movieboli-crema/70">
                      I film per questa serata saranno annunciati presto.
                    </p>
                  </div>
                )}
              </motion.div>
            ...
            >
              ...
              <p className="text-movieboli-crema/80 mb-6 max-w-2xl mx-auto">
                Ogni serata prevede la proiezione di un lungometraggio selezionato seguito da dibattito con il pubblico. 
                Le proiezioni includono presentazione del film e momenti di discussione.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-movieboli-violaPrincipale/10 rounded-lg p-4">
                  ...
                  <div className="text-movieboli-crema/80">21:30</div>
                </div>
                <div className="bg-movieboli-violaPrincipale/10 rounded-lg p-4">
                ...
                {(activeDay === '22 agosto' || activeDay === '24 agosto') && (
                  <div className="bg-movieboli-violaPrincipale/10 rounded-lg p-4">
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <div className="flex items-center space-x-4">
                    <div className="relative w-16 h-24 rounded-lg overflow-hidden border-2 border-movieboli-violaPrincipale/30">
                      <Image
                        src={selectedFilm.foto}
