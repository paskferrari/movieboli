...
import lungometraggiData from './film/film.json';
  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        {/* ... resto del contenuto rimane identico ... */}
        ...
        <section className="relative py-24 bg-gradient-to-br from-movieboli-crema via-white to-movieboli-crema/80 overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              {/* ... resto delle card (OSPITI, FILM, PROGRAMMA) ... */}
              {/* Il contenuto completo è troppo lungo per essere mostrato qui, ma include tutte le sezioni */}
            </div>
          </div>
        </section>
