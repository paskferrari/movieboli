...
const CortoDetailsModal = ({ isOpen, onClose, corto, isLoading }: CortoDetailsModalProps) => {
  ...
  const openTrailerModal = () => {
    if (corto && (corto.trailer || corto.link)) {
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-3/5 p-4 sm:p-6 md:p-8">
              ...
              <div className="mb-4 sm:mb-6 md:mb-8">
                ...
                <p className="text-sm sm:text-base text-movieboli-crema/80 leading-relaxed">
                  {corto.bioRegista || corto.biografia_regista || corto.bio ? (
                    corto.bioRegista || corto.biografia_regista || corto.bio
                  ) : (
              ...
              {/* Pulsante per visualizzare il trailer */}
              {(corto.trailer || corto.link) && (
                <div className="mb-4 sm:mb-6">
                  <motion.button
                    className="py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl font-bold transition-all duration-300 bg-movieboli-violaPrincipale text-movieboli-nero text-sm sm:text-base w-full"
